...
We simulated what are known in the LSST data management system (DM) as
...
The basic simulation was similar to that created for the \mdet\ (TODO cite) and
...
For coaddition, we used the package \texttt{descwl\_coadd}
version 0.3.0\footnote{\url{https://github.com/LSSTDESC/descwl_coadd}}.

This should go elsewhere:  We used the package \texttt{mdet-lsst-sim}
version 0.3.0\footnote{\url{https://github.com/esheldon/mdet-lsst-sim}} to
run the simulation, make coadds and run metadetection.
