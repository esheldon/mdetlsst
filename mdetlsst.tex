...
pixel noise due to the remapping, or ``warping'' to a common pixel grid.  The
...
\ref{sec:sim:satbleeds}).  We did not keep enough information in the output
files to exclude these objects from our catalogs in post processing, and
rerunning would have taken prohibitively long due to limited computing
