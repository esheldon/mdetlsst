...
\subsubsection{Results with Varied Selections on Object Properties} \label{sec:results:cells}
...
\begin{figure}
    ...
    \includegraphics[width=\columnwidth]{{run-riz-drcbWsBPv0.1-cells-s2n-imfrac0.10-mfrac0.02-nocancel-error}.pdf}
