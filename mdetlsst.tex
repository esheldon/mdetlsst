...
objects that are more likely to be detected in both of the paired images, so
using it would result in artificially smaller uncertainties for higher minimum
\snr\ cuts.
...
arcminute.  This is partly due to the relatively large amount of area masked in
the images, as well as the fact that  arelatively small fraction of the
simulated area that had high stellar density.
