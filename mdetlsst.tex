...
We included simulated stars and bleed trails as described in \S
\ref{sec:sim:stars} and \ref{sec:sim:satbleeds}.  In figure \ref{fig:stardens}
we show the multiplicative bias as a function of maximum stellar density and
