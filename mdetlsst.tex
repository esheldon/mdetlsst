...
\subsection{Noise Images} \label{sec:sim:noise}
...
\ref{sec:sim:noise}) we must also run the noise image through the same
...
\esstodo{This should go elsewhere}  We used the package \texttt{mdet-lsst-sim}
