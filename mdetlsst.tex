...
In actual analysis on real data, errors in the low-level characterization of the
data may contribute significantly to the systematic error.  For an unbiased
...
common frame before combination. LSST, for example, will image the survey area
hundreds of times, producing a large data volume, the processing of which
