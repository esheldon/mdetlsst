...
\begin{abstract}
        ...
        shear beyond that expected from higher order shear effects.

        % We identified inadequate star masking as a significant source of
        % potential additional noise in the shear measurements due to spurious
