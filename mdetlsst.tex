...
\end{tikzpicture}
    ...
    stellar density cut.  We interpret this bias as due to the position of
    stars moving after the metacalibraton shear is applied to the image.  The
    stars incorrectly contribute a net value to the calculated shear response,
    biasing the shear recovery.  Bottom panel: increase in the uncertainty on
    the mean shear, relative to a cut at 100/sq. arcminute, a function of the
