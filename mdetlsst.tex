...
shear measurement.
% Lower level characterizations of the data, such as
% determining the flux and astrometric calibration, PSF characterization,
% background determination and finding of artifacts, are most likely be outside
% the purview of the shear measurement code.
%We expect these tasks to be performed by the ``upstream''
%software pipeline.
...
0.2021.32.  This data is stored in an \calexp\ data structure, which carries a
...
detect a bias larger our accuracy goals (see \S \ref{sec:lsstreq}).
...
a density of about 40 stars per square arcminute.  This is expected because
relatively small fraction of the simulated area has high stellar density, and
fields with high stellar density tend to have a relatively large area masked
due to stars.
