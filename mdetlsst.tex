...
by 13\%.  In future work it will be important to use sufficient star masking or
star subtraction, and identify problematic objects.
...
in addition to a cut on size ratio $T/T_{PSF} > 1.2$.  In no case did we
bias beyond that expected from higher order shear effects.
