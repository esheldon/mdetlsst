...
various cut on masked fraction.  \esstodo{figure with more varied cuts on
mfrac}
...
we expect for LSST, we used the measurements for one of the two paired images.
...
10^{-6}$ is the uncertainty in the recovered shear without noise cancellation,
