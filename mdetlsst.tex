...
\begin{abstract}
        ...
        stars were saturated and simulated ``bleed trails'' were drawn when
        appropriate.  Problem areas were interpolated, and the images were
        coadded into small cells, excluding images not fully covering the cell
        to guarantee a continuous PSF.  In all our tests the measured shear was
        accurate within the LSST requirements.
