...
few tenths of a percent level, and implementations of those algorithms that
work with the data products of each survey.

The \mdet\ shear measurement method \citep{mdet20} has been shown to be
accurate up to non-linear shear effects for noisy data with a finite point
spread function (PSF) and overlapping, or blended, galaxy images
...
case to jointly calibrate the shear and redshift distribution of the source
