...
\begin{tikzpicture}
	...
	\addplot+[dashdotted,brown,no markers] coordinates {
        (9.0,0.4)
        (21.0,0.4)
    };
    ...
    % mark requirements
	\addplot+[name path=A,tan,no markers,forget plot] coordinates {
        (9.0,-2)
        (21.0,-2)
    };
    \addplot+[name path=B,tan,no markers,forget plot] coordinates {
        (9.0,2)
        (21.0,2)
    };
    ...
    % bias range as function of S/N
	\addplot+[name path=mlowvar,gray!70,no markers,solid,forget plot] coordinates {
        (10.0,0.219)
        (12.5,0.078)
        (15.0,0.213)
        (20.0,0.257)
    };
    \addplot+[name path=mhighvar,gray!70,no markers,solid,forget plot] coordinates {
        (10.0,1.215)
        (12.5,0.869)
        (15.0,0.973)
        (20.0,0.892)
	...
	\addplot+[name path=mlowfix,gray!90,no markers,solid,forget plot] coordinates {
        (10.0,0.176295)
        (12.5,-0.00826672)
        (15.0,0.165007)
        (20.0,0.111993)
    };
    \addplot+[name path=mhighfix,gray!90,no markers,solid,forget plot] coordinates {
        (10.0,1.13744)
        (12.5,0.789173)
        (15.0,0.915298)
        (20.0,0.765478)
